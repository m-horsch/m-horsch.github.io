...
It took me a while to figure out why there was such a speedup.  I didn't change any of the core solving modules.  I was working on the code that glues the solving modules together.   The difference in speed had nothing to do with my refactoring (that's fine).  The speedup was due to accidentally using a different (newer) version of Python. 
